...
<div class="mySlides fade">
<iframe autoplay style="width: 100%; height:564px;" src="https://www.youtube.com/watch?v=X5Dd78jiSi8&t=1s"></iframe>
</div>

<div class="mySlides fade">
<iframe autoplay style="width: 100%; height:564px;" src="https://www.youtube.com/watch?v=W2Urt7SZeUE"></iframe>
</div>
...
<div class="row">
    <div class="row-item">
        <div>
            <img src="foods/Adeptus Temptation.webp" alt="" width="250">
            <h2>1</h2>
    ...
    <div class="row-item">
        <div>
            <img src="foods/ramen.png" alt="" width="250">
            <h2>2</h2>
            <p>Tonkotsu Ramen</p>
    ...
    <div class="row-item">
        <div>
            <img src="foods/Fontainian Foie Gras.webp" alt="">
            <h2>3</h2>
    ...
    <div class="row-item">
        <div>
            <img src="foods/Tuna Sushi.png" alt="">
            <h2>4</h2>
            <p>Tuna Sushi</p>
...
<div>
    <center><a href="menu.php"><button class="button-85" role="button">Show More</button></a></center>
</div>
...
<div class="aboutus">
    <div class="image">
        <img src="https://wanganmaxi-official.com/wanganmaxi6/en/system/ghost/img/cont02_01.jpg" alt="">
    </div>
    <div class="about">
        <h2>Food Impact</h2>
        <p>
